...
### M: DECODE INSTR &rarr; PSH WAIT WRITE STACK - PSH

### N: DECODE INSTR &rarr; JSR WAIT WRITE STACK - JSR

### O: DECODE INSTR &rarr; JUMP - BCS, BCC, BZS, BZC, BNS, BNC, BOS, BOC

### P: DECODE INSTR &rarr; JUMP - JMP, HLT

### Q: DECODE INSTR &rarr; POP CALCULATE SP - POP

### R: DECODE INSTR &rarr; LD CALC MEM ADDR - LD [Mem]

### S: DECODE INSTR &rarr; STO CALC MEM ADDR - STO

### T: STORE RESULT AND CARRY &rarr; FETCH INSTR

### U: STORE RESULT &rarr; FETCH INSTR

### V: STORE FLAGS &rarr; FETCH INSTR

### X: PSH WAIT WRITE STACK &rarr; FETCH INSTR

### Y: JSR WAIT WRITE STACK &rarr; JUMP

### Z: JUMP &rarr; FETCH INSTR

### AA: POP CALCULATE SP &rarr; WAIT READ MEM

### AB: LD CALC MEM ADDR &rarr; WAIT READ MEM

### AC: STO CALC MEM ADDR &rarr; WAIT WRITE MEM

### AD: WAIT READ MEM &rarr; STORE IN REGISTER

### AE: WAIT WRITE MEM &rarr; FETCH INSTR

### AF: STORE IN REGISTER &rarr; FETCH INSTR

### AG: DECODE INSTR &rarr; FETCH INSTR - BCS, BCC, BZS, BZC, BNS, BNC, BOS, BOC

### AH: DECODE INSTR &rarr; FETCH INSTR - CLC, SEC, CLI, SEI
